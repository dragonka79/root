"""
Print out the devices. Note, that the json output on screen is cut by vscode, for the full working code see 'get_device_23.py'
"""
...
device_response = session.get(url, verify=False).json()
