...
# Get Templates
# template_url = 'https://sandbox-sdwan-1.cisco.com:443/dataservice/template/device'
# template_response = session.get(template_url, verify=False).json()['data']
# print(template_response)
# ip = '4.4.4.61'
# url = f"https://sandbox-sdwan-1.cisco.com:443/dataservice/device/policy/qosschedulerinfo?deviceId={ip}"
