...
# Create a functions with default values (parameter values in case of either of the responsible parameter 
# is missing when calling a function)
...
if __name__ == '__main__':
    ...
    # Order does not matter in passing parameters to a function by pure keyword
    devices = create_devices(num_subnets=3, num_devices=6)
