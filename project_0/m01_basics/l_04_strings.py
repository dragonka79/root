...
# STRIP, getting rid of blanks in the beginning and at the end of the whole list
device1 = device1_str.strip().split(",")
print("device1 using strip and split:")
print("    ", device1)

# REMOVE BLANKS from everywhere: replacing " " with ""
device1 = device1_str.replace(" ", "").split(",")
print("device1 removed blanks using replace:\n    ", device1)
...
Loopback21
          Switching path    Pkts In   Chars In   Pkts Out  Chars Out
               Processor          0          0          0          0
             Route cache          0          0          0          0
       Distributed cache          0       print(show_interface_stats.splitlines())   0          0          0
