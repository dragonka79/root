...
# Getting over 'device_str', separating them by ',', removing the whitespaces at the beginning and at the end of the string 
# and put the items to a list named 'device'.

device = list()
for item in device_str.split(","):
    device.append(item.strip()) # Strip: removing the whitespaces at the beginning and at the end of the string
...
# Defining 'device_info' as a list with tuple items
