#EZ AZ EX25 AZON VÁLTOZATA, AMELYET LEHET DIREKTBEN FUTTATNI, ITT JOBBAN LÁTSZIK,
...
wordok = break_words(sentence)
print("A szavakra tördelt mondat:", wordok)
...
def sort_words(words):
    """Sorts the words"""
    return sorted(words)
sorted_wordok = sort_words(wordok)
print("A szavakra tördelt mondat szavai sorba rakva:", sorted_wordok)


#A print_first_word nevű függvény megfogja az első szót a listában amit
#bemenetre kap és kiszedi a listából és egy word nevű változóba rakja a
#kiszedett szót a words pedig ezzel a kiszedett szót nem fogja tartalmazni.
#az eredeti feladatban a bemenetre kapott lista a words és a sorted_words
...
print_first_and_last_sorted(sorted_wordok)
